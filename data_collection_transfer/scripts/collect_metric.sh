...
curl -k --request POST "https://influxdb2:8086/api/v2/write?org=protexai&bucket=metrics&precision=s" --header "Authorization: Token I32gMCLeiXSr9AAvmVc3qMYPlbOG10FDJVHCyzToKYZXV8C4E63cVBJjHvKWE2Uj9iOsrD-JI9GaVjBKd3ip2A==" --data-raw "metrics,host=${HOSTNAME} memory="${mem_util}",cpu=${cpu_util},disk=${disk_util}"
